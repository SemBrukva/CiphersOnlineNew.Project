...
/**
 * Сервис настроек инструмента перебора всех сдвигов шифра Цезаря.
 */
final readonly class CaesarBruteForceService
{
    /**
    ...
    /**
     * Возвращает элементы блока доверия для инструмента перебора.
     *
     * @return string[]
     */
