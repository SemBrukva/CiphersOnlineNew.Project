...
/**
 * Детектор шифра Альберти.
 *
 * Статистически схож с Vigenere — IoC в полиалфавитной зоне.
 */
final readonly class AlbertiDetector implements CipherDetectorInterface
{
    /**
     * {@inheritDoc}
     */
    public function detect(IdentificationContext $ctx): ?CipherDetection
    {
        ...
        return new CipherDetection(
            toolSlug: 'classical-ciphers/alberti',
            cipherKey: 'CIPHER_NAME_ALBERTI',
            confidence: 0.40,
