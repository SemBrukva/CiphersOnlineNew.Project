...
final readonly class BaseToolUiFactory
{
    ...
    public function build(string $toolSlug, string $calculationMode): array
    {
        return [
            ...
            'embedLabel' => trans('CIPHER_TOOL_EMBED_LABEL'),
            'embedDialogTitle' => trans('CIPHER_TOOL_EMBED_DIALOG_TITLE'),
            'embedDialogHint' => trans('CIPHER_TOOL_EMBED_DIALOG_HINT'),
            'embedCopyLabel' => trans('CIPHER_TOOL_EMBED_COPY_LABEL'),
            'embedCloseLabel' => trans('CIPHER_TOOL_EMBED_CLOSE_LABEL'),
            'embedCopiedLabel' => trans('CIPHER_TOOL_EMBED_COPIED'),
            'embedCopyFailedLabel' => trans('CIPHER_TOOL_EMBED_COPY_FAILED'),
