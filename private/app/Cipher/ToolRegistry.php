...
final readonly class ToolRegistry
{
    ...
    public function __construct(
        ...
        private ScytaleCipherService $scytaleCipher,
    ...
    public function exampleChips(string $toolSlug): array
    {
        ...
        return match ($canonicalSlug) {
            ...
            'hashing/sha256' => [
                ...
                ['label' => 'JSON',     'value' => '{"user":"alice","role":"admin"}'],
                ['label' => 'Unicode',  'value' => 'Café naïve résumé ☕'],
            ],
            'hashing/sha1' => [
                ['label' => 'Hello',    'value' => 'hello world'],
                ['label' => 'Git blob', 'value' => 'commit-message-v1'],
                ['label' => 'Password', 'value' => 'password123'],
                ['label' => 'Unicode',  'value' => 'Café naïve résumé ☕'],
            ],
            'hashing/sha512' => [
                ['label' => 'Hello',    'value' => 'hello world'],
                ['label' => 'JSON',     'value' => '{"user":"alice","role":"admin"}'],
                ['label' => 'Long',     'value' => 'The quick brown fox jumps over the lazy dog'],
                ['label' => 'Unicode',  'value' => 'Café naïve résumé ☕'],
            ],
            'hashing/md5' => [
                ['label' => 'Hello',    'value' => 'hello world'],
                ['label' => 'Cache key','value' => 'user:42:profile'],
                ['label' => 'ETag',     'value' => 'v2-content-body-2024-01-15'],
                ['label' => 'Unicode',  'value' => 'Café naïve résumé ☕'],
            ],
            'hashing/sha3-256' => [
                ['label' => 'Hello',    'value' => 'hello world'],
            ...
            'classical-ciphers/scytale' => [
                ['label' => 'Classic',  'value' => 'WEAREDISCOVEREDFLEEATONCE', 'shift' => 4],
                ['label' => 'Military', 'value' => 'ATTACK AT DAWN',            'shift' => 5],
                ['label' => 'Decode',   'value' => 'WECRLTEEDOEEOAIVDENRSEFAC', 'shift' => 4, 'direction' => 'decrypt'],
            ],
    ...
    private function canonicalSlug(string $toolSlug): string
    {
        return match ($toolSlug) {
            ...
            'classical-ciphers/scytale-cipher', 'classical-ciphers/skytale', 'classical-ciphers/skitala', 'classical-ciphers/shifr-scytale' => 'classical-ciphers/scytale',
