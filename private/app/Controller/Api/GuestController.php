...
final class GuestController
{
    ...
    /**
     * Выполняет шифрование/дешифрование Хилла через API.
     *
     * POST /api/tools/hill
     */
    #[ApiOperation(summary: 'Шифр Хилла', tags: ['tools'])]
    #[ApiResponse(status: 200, description: 'Результат обработки')]
    #[ApiResponse(status: 422, description: 'Ошибки валидации')]
    public function hill(Request $request): Response
    {
        return $this->handleCipherTool($request, 'hill');
    }
     ...
     */
    #[ApiOperation(summary: 'Vigenère Cracker', tags: ['tools'])]
    #[ApiResponse(status: 200, description: 'Результат взлома с найденным ключом и кандидатами')]
    #[ApiResponse(status: 422, description: 'Ошибки валидации')]
    public function vigenereCracker(Request $request): Response
    {
        return $this->handleCipherTool($request, 'vigenere-cracker');
    }

    /**
     * Выполняет шифрование/дешифрование шифром Бифид через API.
     *
     * POST /api/tools/bifid
     */
    #[ApiOperation(summary: 'Bifid Cipher', tags: ['tools'])]
    #[ApiResponse(status: 200, description: 'Результат обработки')]
    #[ApiResponse(status: 422, description: 'Ошибки валидации')]
    public function bifid(Request $request): Response
    {
        return $this->handleCipherTool($request, 'bifid');
    }
     ...
     */
    #[ApiOperation(summary: 'Trifid Cipher', tags: ['tools'])]
    #[ApiResponse(status: 200, description: 'Результат обработки')]
    #[ApiResponse(status: 422, description: 'Ошибки валидации')]
    public function trifid(Request $request): Response
    {
        return $this->handleCipherTool($request, 'trifid');
    }
