...
/**
 * Тесты детектора шифра Гронсфельда.
 */
final class GronsfeldDetectorTest extends DetectorTestCase
{
    private GronsfeldDetector $detector;

    protected function setUp(): void
    {
        parent::setUp();
        $this->detector = new GronsfeldDetector();
    }
